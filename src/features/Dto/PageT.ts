...
export type PageTypeT = 
    ...
    "people" | "phone_number" | "relation" | "rollup" | "rich_text" | "select" | "status" | "title" | "url" | "unique_id" | "verification"
...
export type FunctionTypeT = "average" | "checked" | "count" | "count_per_group" | "count_values" | "date_range" | "earliest_date" | "empty" |
    "latest_date" | "max" | "median" | "min" | "not_empty" | "percent_checked" | "percent_empty" | "percent_not_empty" | "percent_per_group" | "percent_unchecked" |
